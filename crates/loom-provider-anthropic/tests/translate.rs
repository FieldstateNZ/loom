...
use loom_core::{
    CacheHint, CacheTtl, ContentPart, Conversation, ConversationOptions, McpServerRef, Message,
    ProviderBinding, Role, ServerTool, ToolDefinition,
};
...
/// A conversation binding used by the server-tool request tests.
